...
/**
 * Class DateTimeDMYHIS_Test.
 *
 * @coversDefaultClass Kicaj\Tools\Date\DateTimeDMYHIS
 *
 * @author             Rafal Zajac <rzajac@gmail.com>
 */
class DateTimeDMYHIS_Test extends \PHPUnit_Framework_TestCase
{
    /**
     * @covers ::__construct
     * @covers ::getFormat
    ...
    {
        // When
        $dt = new DateTimeDMYHIS();

        // Then
        $this->assertSame('d-m-Y H:i:s', $dt->getFormat());
    }
    ...
    {
        // Given
        $dt = new DateTimeDMYHIS('2020-10-12');
    ...
    public function test_format_hollow_not_hollow()
    {
        ...
        // Then
        $this->assertSame('01-01-1970 00:00:00', $dt->format());
    }
    ...
    {
        // When
        $dt = new DateTimeDMYHIS('1956-11-12 11:12:13');

        // Then
        $this->assertSame('12-11-1956 11:12:13', $dt->format());
    }
    ...
    {
        return [
            ['2013-09-22 09:08:10', '22-09-2013 09:08:10'],
        ];
    }
}
